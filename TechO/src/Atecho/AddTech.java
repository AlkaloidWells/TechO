...
public class AddTech extends javax.swing.JFrame {
   zzz conecta = new zzz();
    ...
    private void initComponents() {
        ...
        kGradientPanel1.add(tname, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 160, 20));
        ...
        z.setBorder(null);
        z.setOpaque(false);
        kGradientPanel8.add(z, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 160, 20));
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
      ...
      if(tname.getText().length()== 0)
        ...
        else
        {
             ...
             String mcat1 = (String) mcat.getSelectedItem();
             String subcat1 = (String) subcat.getSelectedItem();
             String catname1 = catname.getText();
             String desp1 = desp.getText();
             String cotry = country.getText();
             String sta = state.getText();
             String ct = city.getText();
             String obj1 = obj.getText();
             String tlink = tslink.getText();
             String auth = aname.getText();
            ...
            try{
               ...
               //_______________________________________________________________________________________________
                ...
                System.out.println("000x!");
                pst = conecta.conn.prepareStatement("insert into main.catigoury(maingroup, subgroup, catname)values(?, ?,?)");
                pst.setString(1, mcat1);
                pst.setString(2, subcat1);
                pst.setString(3, catname1);
                System.out.println("001!");
                pst.executeUpdate();
                System.out.println("002!");
                conecta.executaSQL("SELECT MAX(cat_id) FROM main.catigoury");
                System.out.println("003!");
                // Retrieve the maximum primary key value
                if (conecta.rs.next()) {
                 pkc = conecta.rs.getInt(1);
                ...
                pst1.setString(1, mcat1);
                pst1.setString(2, subcat1);
                pst1.setString(3, catname1);
